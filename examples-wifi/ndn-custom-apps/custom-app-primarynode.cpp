...
{
  this->ESPLogFile.open("PrimaryTimerLog.txt");
  ...
  Simulator::Schedule(Seconds(14.9),&PrimaryNode::PrintLocalBlockchain, this);
}
...
void PrimaryNode::ConfigurationPhase(){
  ...
  Simulator::Schedule(Seconds(2),&PrimaryNode::ConfigureESPGhostNode, this);
  Simulator::Schedule(Seconds(3),&PrimaryNode::ConfigureConsumerOneNode, this);
  Simulator::Schedule(Seconds(4),&PrimaryNode::ConfigureConsumerTwoNode, this);
  Simulator::Schedule(Seconds(5),&PrimaryNode::ConfigureConsumerThreeNode, this);
  Simulator::Schedule(Seconds(6),&PrimaryNode::ConfigureProducerNode, this);
  //register IKCB rules
  Simulator::Schedule(Seconds(7),&PrimaryNode::ProducerAppIKCB, this);
  Simulator::Schedule(Seconds(8),&PrimaryNode::ProducerAppPrefixRegistration, this);
}
