...
#include "custom-app-consumerthree.hpp"
...
NS_LOG_COMPONENT_DEFINE("ConsumerThreeApp");

using namespace BlockNDN;

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED(ConsumerThreeApp);

// register NS-3 type
TypeId
ConsumerThreeApp::GetTypeId()
{
  static TypeId tid = TypeId("ConsumerThreeApp")
  .SetParent<ndn::App>()
  .AddConstructor<ConsumerThreeApp>();
  return tid;
}

// Processing upon start of the application
void
ConsumerThreeApp::StartApplication()
{
  this->myName = "ConsumerThreeApp";
  ...
  //Simulator::Schedule(Seconds(59),&ConsumerThreeApp::PrintLocalBlockchain, this);
  //Simulator::Schedule(Seconds(59),&ConsumerThreeApp::PrintPrepareLog, this);
}


// Processing when application is stopped
void
ConsumerThreeApp::StopApplication()
{
...
void
ConsumerThreeApp::OnInterest(std::shared_ptr<const ndn::Interest> interest)
{
  ...
  //NS_LOG_DEBUG("[ConsumerThreeApp]: Received Interest packet for " << prefix.substr(0,10));
...
bool ConsumerThreeApp::checkPrepareConsensus(){
  int quorum = 0;
...
void
ConsumerThreeApp::PrintLocalBlockchain()
{
  this->blockChainProxy.PrintBlockChainToScreen(this->myName);
};

void
ConsumerThreeApp::PrintPrepareLog()
{
    std::cout << "********************************************************" << std::endl;
...
void ConsumerThreeApp::clearLocalData()
{
  this->currentBlockInProcess.s = "";
...
void
ConsumerThreeApp::OnData(std::shared_ptr<const ndn::Data> data)
{
