...
// 		unsigned char * blockSizeResult = intToByte(newBlock.blockSize);
// 		byteArray.push_back((unsigned char) blockSizeResult[0]);
// 		byteArray.push_back((unsigned char) blockSizeResult[1]);
// 		byteArray.push_back((unsigned char) blockSizeResult[2]);
// 		byteArray.push_back((unsigned char) blockSizeResult[3]);
...
// 		delete blockSizeResult;


// 		//convert the time to bytes
// 		unsigned char * timeResult = longToByte(newBlock.time);
// 		byteArray.push_back((unsigned char) timeResult[0]);
// 		byteArray.push_back((unsigned char) timeResult[1]);
// 		byteArray.push_back((unsigned char) timeResult[2]);
// 		byteArray.push_back((unsigned char) timeResult[3]);
// 		byteArray.push_back((unsigned char) timeResult[4]);
// 		byteArray.push_back((unsigned char) timeResult[5]);
// 		byteArray.push_back((unsigned char) timeResult[6]);
// 		byteArray.push_back((unsigned char) timeResult[7]);
...
// 		unsigned char * nonceResult = longToByte(newBlock.nonce);
// 		byteArray.push_back((unsigned char) nonceResult[0]);
// 		byteArray.push_back((unsigned char) nonceResult[1]);
// 		byteArray.push_back((unsigned char) nonceResult[2]);
// 		byteArray.push_back((unsigned char) nonceResult[3]);
// 		byteArray.push_back((unsigned char) nonceResult[4]);
// 		byteArray.push_back((unsigned char) nonceResult[5]);
// 		byteArray.push_back((unsigned char) nonceResult[6]);
// 		byteArray.push_back((unsigned char) nonceResult[7]);
...
// 		std::string bbb(byteArray.begin(),byteArray.end());
