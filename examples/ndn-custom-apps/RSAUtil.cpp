...
char* RSAUtil::signMessage(std::string privateKey, std::string plainText) {
...
bool RSAUtil::verifySignature(std::string publicKey, std::string plainText, char* signatureBase64) {
